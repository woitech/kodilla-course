...
public class Watcher {
    ...
    @After("execution(* com.kodilla.patterns2.aop.calculator.Calculator.*(double, double))" +
            " && args(x, y) && target(object)")
    public void logEvent(double x, double y, Object object){
        LOGGER.info("Class: " + object.getClass().getName() + ", Args: " + x + ", " + y);
    }
