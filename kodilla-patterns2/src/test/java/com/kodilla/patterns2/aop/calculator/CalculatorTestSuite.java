...
public class CalculatorTestSuite {
    ...
    public void testFactorial() {
        ...
        assertEquals(0, result.compareTo(new BigDecimal(3628800)));
    }

    @Test
    public void testFactorialBigResult() {
        //Given
        //When
        BigDecimal bigResult = calculator.factorial(new BigDecimal(1000));
        //Then
        LOGGER.info("Testing factorial method with big result");
        assertEquals(1, bigResult.compareTo(new BigDecimal(1000 * 999 * 998)));
    }
}